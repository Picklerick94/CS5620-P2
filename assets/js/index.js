const Index = () => {
  ...
  `;
    ...
    tweets.forEach((tweet) => {
      ...
      const id = tweet.studentId;
      const name = encodeURIComponent(tweet.name);
      const nuid = tweet.NUID;
      ...
      <div class="operation">
        <a class="detail-link" href="./student/${id}">Detail</a>
        <button class="operation-button
        edit-button"
        data-studentid=${id} data-name=${name} data-nuid=${nuid}>
          Edit
        </button>
        <button class="operation-button delete-button" data-studentid=${id}>Delete</button>
      </div>
    `;
